        ...
        <div className="flex h-[520px] w-full flex-col rounded-3xl bg-white/90 p-4 shadow-lg ring-1 ring-[#cededb] sm:max-w-xs">
          <header className="mb-4 flex items-center justify-between text-xs font-medium text-slate-700">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                href="/demo/home"
                className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-[#f3e8ff] text-[10px] font-semibold text-slate-800 hover:bg-[#e9d5ff]"
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-4 text-sm">
            ...
            <h1 className="text-base font-semibold text-slate-900">Parent view</h1>
            <p className="px-4 text-center text-xs text-slate-600">
              A launcher screen for caregivers to check activity, adjust
              settings, and guide their child&apos;s experience.
            </p>
          </div>
        </div>
      </div>
